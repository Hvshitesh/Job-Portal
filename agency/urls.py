...
urlpatterns = [
    ...
    url(r"^recruiters/$", company_recruiter_list, name="company_recruiter_list"),
    url(r"^recruiter/add/$", company_recruiter_create, name="company_recruiter_create"),
    url(
        r"^recruiter/edit/(?P<recruiter_id>[a-zA-Z0-9]+)/$",
        edit_company_recruiter,
        name="edit_company_recruiter",
    ),
    url(
        r"^recruiter/delete/(?P<recruiter_id>[a-zA-Z0-9]+)/$",
        delete_company_recruiter,
        name="delete_company_recruiter",
    ),
    url(
        r"^recruiters/status/(?P<recruiter_id>[a-zA-Z0-9]+)/$",
        activate_company_recruiter,
        name="activate_company_recruiter",
    ),
    url(
        r"^recruiters/profile/(?P<recruiter_id>[a-zA-Z0-9]+)/$",
        company_recruiter_prof  ile,
